...
glm::mat4 Camera::orientation() const {
	auto orientation = glm::identity<glm::mat4>();
...
glm::mat4 Camera::projection() const {
	return glm::perspective(glm::radians(m_fov), _viewportAspectRatio, m_near_plane, m_far_plane);
}

glm::mat4 Camera::view() const {
	return orientation() * glm::translate(glm::identity<glm::mat4>(), -_position);
}
